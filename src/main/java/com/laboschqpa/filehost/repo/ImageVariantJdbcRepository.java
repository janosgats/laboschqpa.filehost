...
import com.laboschqpa.filehost.enums.attributeconverter.UploadKindAttributeConverter;
...
public class ImageVariantJdbcRepository {
    private static final int UPLOAD_KIND_IMAGE_VARIANT
            = new UploadKindAttributeConverter().convertToDatabaseColumn(UploadKind.IMAGE_VARIANT);
